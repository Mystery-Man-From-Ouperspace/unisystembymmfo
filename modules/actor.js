export class unisystemActor extends Actor {
    ...
    _prepareCharacterData(actorData) {
      ...
      let terraprimatechaTypeLabel = data.terraprimatecharacterTypes[data.terraprimatecharacterType]
      ...
      if(terraprimatechaTypeLabel != undefined) {
        ...
        data.terraprimatecharacterTypeValues[terraprimatechaTypeLabel].drawbackPoints.value = this._calculateDrawbackPoints(data)
        data.terraprimatecharacterTypeValues[terraprimatechaTypeLabel].skillPoints.value = this._calculateSkillPoints(data)
        data.terraprimatecharacterTypeValues[terraprimatechaTypeLabel].metaphysicsPoints.value = this._calculateMetaphysicsPoints(data)
      }
      if(afmbechaTypeLabel != undefined) {
        data.afmbecharacterTypeValues[afmbechaTypeLabel].attributePoints.value = this._calculateAttributePoints(data)
        data.afmbecharacterTypeValues[afmbechaTypeLabel].qualityPoints.value = this._calculateQualityPoints(data)
        data.afmbecharacterTypeValues[afmbechaTypeLabel].drawbackPoints.value = this._calculateDrawbackPoints(data)
        data.afmbecharacterTypeValues[afmbechaTypeLabel].skillPoints.value = this._calculateSkillPoints(data)
        data.afmbecharacterTypeValues[afmbechaTypeLabel].metaphysicsPoints.value = this._calculateMetaphysicsPoints(data)
      }
      if(witchcraftchaTypeLabel != undefined) {
        data.witchcraftcharacterTypeValues[witchcraftchaTypeLabel].attributePoints.value = this._calculateAttributePoints(data)
        data.witchcraftcharacterTypeValues[witchcraftchaTypeLabel].qualityPoints.value = this._calculateQualityPoints(data)
        data.witchcraftcharacterTypeValues[witchcraftchaTypeLabel].drawbackPoints.value = this._calculateDrawbackPoints(data)
        data.witchcraftcharacterTypeValues[witchcraftchaTypeLabel].skillPoints.value = this._calculateSkillPoints(data)
        data.witchcraftcharacterTypeValues[witchcraftchaTypeLabel].metaphysicsPoints.value = this._calculateMetaphysicsPoints(data)
      }
